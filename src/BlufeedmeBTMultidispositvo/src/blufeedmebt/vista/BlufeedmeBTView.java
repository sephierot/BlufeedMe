...
public class BlufeedmeBTView extends FrameView {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = BlufeedmeBTApp.getApplication().getMainFrame();
            aboutBox = new BlufeedmeBTAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        BlufeedmeBTApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(blufeedmebt.vista.BlufeedmeBTApp.class).getContext().getResourceMap(BlufeedmeBTView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(blufeedmebt.vista.BlufeedmeBTApp.class).getContext().getActionMap(BlufeedmeBTView.class, this);
